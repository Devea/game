...
<html>
    ...
    <body>
        ...
        if(isset($_POST['name'])){
            // insert
            mysql_query("INSERT INTO login (name, password, title, img, hardcore) VALUES ('".$_POST['name']."','".$_POST['password']."','".$_POST['title']."','".$_FILES['file']['name']."',".$_POST['hardcore'].")");
            move_uploaded_file($_FILES["file"]["tmp_name"], "photos/" . $_FILES["file"]["name"]); // nefunguje na linuxech
        }
        ?>
    </body>
</html>
